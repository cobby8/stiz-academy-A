...
- 기준일: 2026-07-07
- 문서 수: 5
- 최근 지식: 선생님용 `/staff/quick-post`에서 사진을 올리면 AI 인스타 초안이 생성되고, `/admin/gallery`에서 관리자가 피드 미리보기로 수정/승인 후 홈페이지 갤러리와 인스타그램에 게시한다.
...
- 선생님 인스타 자동화는 `SocialPostDraft` 초안을 거쳐 관리자 승인 후 게시한다.
