...
- 현재 단계: 관리자 선택 요청의 재확인 링크·안내 준비, 차액 PaymentInvoice 동일 거래·미리보기 해시 연결 완료. 회귀45·TypeScript·QA 통과, 실제 발송/운영 DB/배포 미검증.
...
## 확인보류
- 다음 개발: 재확인 안내 실제 채널 전달/승인·결과 장부, 반 변경 전용 어댑터/완료 연결, 입학 증거 직접 연결·영구 저장. 과거 Payment만 있는 차액 건은 별도 확인. 전체 운영 DB/E2E 전 배포 보류.
