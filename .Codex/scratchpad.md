...
## 작업 로그 (최근 10건)
- 2026-09-11: 기사님 운행 시작 안내 박스와 문구 제거, 헤더 우측 소형 운행 시작 버튼으로 이동. 관련 회귀 18건·tsc·diff-check 통과, 푸시·배포 없음.
- 2026-09-11: 기사님 운행 시작 영역 우측 상단에 순서·시간 수정 소형 버튼 배치, 카드 상단 격자와 학생 행 재압축. 관련 회귀 18건·tsc·diff-check 통과, 푸시·배포 없음.
- 2026-09-11: 배포 전 릴리스 검사에서 발견된 월 장부 UTC 날짜 검증·Vercel 빌드 명령 기대값 불일치 보완. 전체 릴리스 코드 검사 1,602건·Prisma·tsc 통과, 운영 DB·발송·배포는 병합 뒤 진행.
- 2026-09-11: 통합 기사님 운행 카드의 길안내를 시간 아래 소형 버튼으로 이동하고, 학생 연락처·탑승 행을 압축. 관련 회귀 17건·tsc·diff-check 통과, 운영 DB·발송·배포 없음.
