    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-extrabold text-gray-900">청구 템플릿 설정</h1>
            ...
            {showForm && (
                <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-xl p-6 mb-6 shadow-sm space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        {/* 납부기한일 */}
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1">매월 납부기한일</label>
                            <input
                                type="number"
                                min={1}
                                max={28}
                        ...
                        {/* 연결 프로그램 */}
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1">연결 프로그램 (선택)</label>
                            <select
                                value={programId}
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase">유형</th>
                                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase">금액</th>
                                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase">납부기한일</th>
