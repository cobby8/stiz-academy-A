...
- 목표: 신규 학생 최초 등록의 청구·알림·Rallyz 초대 완료 규칙을 공용 운영 절차에 고정한다.
- 현재 단계: 공용 스킬·청구 정책·결정 기록 갱신 및 검증 중. 신규 수강신청 1건은 변경된 미리보기 승인 대기.
- 운영 반영: 운영 DB 변경, 배포, 외부 알림 없음.
- 별도 실행 대기: 성인반 복귀 1건은 세 시스템 금액 불일치 확인보류.
