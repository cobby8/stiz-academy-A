...
export default function SimulatorLoading() {
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* 위저드 영역 스켈레톤 */}
            <div className="py-12 md:py-16 bg-surface-section">
                <div className="max-w-2xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
                        <div className="h-7 w-48 bg-gray-100 rounded mb-3 animate-pulse" />
                        <div className="h-4 w-64 bg-gray-100 rounded mb-6 animate-pulse" />
                        <div className="h-12 w-full bg-gray-100 rounded-xl mb-6 animate-pulse" />
