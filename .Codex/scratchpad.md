...
- 현재 단계: 1차 읽기 전용 반별 월 점검표·다반 REVIEW·신규 Payment ID 한정 발행 구현. 확정 월 장부 저장/요금·할인·이월 편집/운영 E2E는 미완료.
...
## 확인보류
- 사용자가 복수 반은 시트 별도 행임을 확인. 다음은 사이트 고유 월별·반별 확정 장부와 할인·이월 근거 저장. 현재 점검표는 영구 월 장부/시트 대체가 아님. 실DB·브라우저 E2E·배포 미검증.
