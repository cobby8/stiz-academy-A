export const DEFAULT_PRIVACY_POLICY = `제1조 (개인정보의 처리 목적)
STIZ 농구교실(이하 "학원")은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
...
제2조 (수집하는 개인정보 항목)
학원은 서비스 제공을 위해 다음과 같은 개인정보를 수집합니다.
...
학원은 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.
...
제4조 (개인정보의 제3자 제공)
학원은 원칙적으로 정보주체의 개인정보를 제3자에게 제공하지 않습니다. 다만, 다음의 경우에는 예외로 합니다.
...
제7조 (미성년자의 개인정보 보호)
학원은 만 14세 미만 아동의 개인정보를 수집할 때 법정대리인(보호자)의 동의를 받아 수집합니다.
...
제10조 (개인정보 처리방침 변경)
이 개인정보 처리방침은 2026년 3월 29일부터 적용됩니다. 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.
