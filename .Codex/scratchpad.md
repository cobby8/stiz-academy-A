...
## 현재 작업
- 작업명: 개인정보처리방침 백그라운드 로딩
- 상태: 빌드 검증 완료
- 범위: `/admin/privacy`, `/api/admin/settings`
- 기준일: 2026-07-10
...
## 구현 기록
- 변경 파일: `src/app/admin/privacy/page.tsx`, `src/app/admin/privacy/PrivacyAdminClient.tsx`
- 주요 변경: 개인정보처리방침 조회를 기존 설정 API로 분리하고, 로딩 중 skeleton을 클라이언트에서 표시.
- 적용 범위: `/admin/privacy`
