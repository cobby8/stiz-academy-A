...
| 배포/검증/의존 제거 | 진행 중 | 운영 DB에 `ScheduleSlot` 32건 이관 완료, 수강생 미연결 원본 중 빈 차량 서식 992건을 검토 제외로 분리 |
...
## 다음에 할 것
- 남은 차량 2건/대표팀 14건을 관리자 화면에서 수동 연결하거나, DB에 아직 없는 대표팀 학생을 신규 등록하는 흐름을 정한다.
