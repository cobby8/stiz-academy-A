        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <aside className="w-64 bg-brand-navy-900 text-white flex-shrink-0 fixed h-full z-10 transition-transform flex flex-col">
                ...
                <nav className="p-4 space-y-1 flex-1">
                    ...
                    <NavItem href="/admin/programs" active={pathname.startsWith("/admin/programs")} icon="📋" label="프로그램·수강료" />
                    <NavItem href="/admin/classes" active={pathname.startsWith("/admin/classes")} icon="🕐" label="수업시간표 관리" />
                    <NavItem href="/admin/annual-events" active={pathname.startsWith("/admin/annual-events")} icon="📅" label="연간일정표 관리" />
