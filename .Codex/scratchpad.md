...
- 상태: **오전 10시 통합 예약 + 랠리즈 출석 어댑터 구현·검증 완료 / 출석 실반영은 배포 대기**
- 기준일: 2026-08-26
...
- 수4: 김지훈·박재윤은 홈페이지 활성 명단에 없어 보류.
- 수5: 랠리즈 김도현 ↔ 홈페이지 김도현B는 관리명 근거가 없어 보류.
- 수6: 원지섭은 홈페이지 명단에 없어 보류, 정휘건은 미처리. 홈페이지 배유빈·이윤건은 랠리즈 명단에 없음.
- 수7: 5명 전원 미처리. 홈페이지 여민재는 랠리즈 명단에 없음.
